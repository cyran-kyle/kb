...
let mentioned = participants.map(v => v.jid)
 ...
 case 'resetlinkgc':
    ...
    case 'group': case 'grup': {
     ...
     sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "233596371001@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
     } else if (sizny > 20) {
     await A17.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
     replay("Joined !")
     } else {
 ...
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
    ...
    reply(mess.waiting)	
             ...
             let anu = await maker.textpro(link, q)
                A17.sendMessage(m.chat, { image: { url: anu }, caption: `Made by Turbo Bot By Cyran Kyle...  🪄` }, { quoted: m })
             }
...
case 'charactercheck':
 ...
 case 'dare':
	...
	A17.sendMessage(from, { react: { text: "🌝" , key: m.key }})
         ...
         "shout *Onii Chaan* in front of your house",
         "snap/post boyfriend photo/crush",
         "tell me your boyfriend type!",
         "say *i hv crush on you, do you want to be my girlfriend?* to the opposite sex, the last time you chatted (submit on wa/tele), wait for him to reply, if you have, drop here",
         "record ur voice that read *yamete kuda sai onii chaann*",
         ...
         "send voice note says i hv crush on you, want to be my girlfriend/boyfriend or not? to any random person from the group(if u girl choose boy, if boy choose girl",
         ...
         "say i love the bot owner Cyran Kyle through voice note",
         ...
         "breakup with your best friend for 5hrs without telling him/her that its a dare",
          ...
          "send abusive words in any group, excepting this group, and send screenshot proof here"
     ]
...
│───────────────────────│
┠⬡│▸ ${pushname} I am *Turbo Bot*, a Bot Developed by *Cyran Kyle*.
│───────────────────────│
│╭────────────────···▸
┠─────═[ *TODAY* ]═────
│╰────────────────···▸
...
const txt = `Do you love Turbo Bot? Then we are the same.`
const A17array= [
